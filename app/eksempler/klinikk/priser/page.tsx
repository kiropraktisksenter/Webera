    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/eksempler/klinikk/priser" className="text-teal-200 font-semibold">Priser</Link>
              <Link href="/eksempler/klinikk/om-oss" className="hover:text-teal-200 transition">Om oss</Link>
              <Link href="/eksempler/klinikk/kontakt" className="bg-white text-teal-600 px-6 py-2 rounded-full font-semibold hover:bg-teal-50 transition">Kontakt</Link>
            </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
            ...
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="text-3xl font-bold text-teal-600">{item.price}</div>
                </div>
          ...
          <div className="bg-gradient-to-br from-teal-50 to-white p-8 rounded-3xl">
            <h3 className="text-2xl font-bold text-teal-900 mb-6">Refusjon</h3>
