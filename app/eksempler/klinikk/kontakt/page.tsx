    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-100 to-white">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/eksempler/klinikk/priser" className="hover:text-stone-300 transition">Priser</Link>
              <Link href="/eksempler/klinikk/om-oss" className="hover:text-stone-300 transition">Om oss</Link>
              <Link href="/eksempler/klinikk/kontakt" className="text-stone-300 font-semibold">Kontakt</Link>
            </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-stone-200">Vi hjelper deg gjerne</p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">Bestill time</h2>
            <form className="space-y-6">
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Navn</label>
                <input type="text" className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-slate-900 focus:outline-none" placeholder="Ola Nordmann" />
              </div>
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Telefon</label>
                <input type="tel" className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-slate-900 focus:outline-none" placeholder="+47 123 45 678" />
              </div>
              <div>
                <label className="block text-gray-700 font-semibold mb-2">E-post</label>
                <input type="email" className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-slate-900 focus:outline-none" placeholder="ola@eksempel.no" />
              </div>
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Tjeneste</label>
                <select className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-slate-900 focus:outline-none">
              ...
              <div>
                ...
                <textarea rows={4} className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-slate-900 focus:outline-none" placeholder="Beskriv dine behov..."></textarea>
              </div>
              <button type="button" className="w-full bg-slate-900 text-white px-8 py-4 rounded-full font-semibold hover:bg-slate-800 transition text-lg shadow-lg">
                Send forespørsel
              </button>
            </form>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-3xl shadow-lg">
              <h3 className="text-2xl font-bold text-slate-900 mb-6">Kontaktinformasjon</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900">E-post</div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg">
              <h3 className="text-2xl font-bold text-slate-900 mb-6">Åpningstider</h3>
